...
import com.goatify.music.utils.BotDetectionMitigator
...
import com.goatify.music.utils.cipher.CipherDeobfuscator
import com.goatify.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.goatify.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.goatify.music.utils.YTPlayerUtils.validateStatus
import com.goatify.music.utils.potoken.PoTokenGenerator
import com.goatify.music.utils.potoken.PoTokenResult
import com.goatify.music.utils.sabr.EjsNTransformSolver
import com.goatify.music.utils.PlaybackLogLevel
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        val showFallbackToast = context?.let { 
            it.dataStore.data.first()[com.goatify.music.constants.ShowAudioFallbackToastKey] 
        } ?: true
...
fun confidence(queryArtist: String, queryTitle: String, queryDuration: Long?, candidate: com.goatify.music.utils.qobuz.QobuzTrack): Float {
