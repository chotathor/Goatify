...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/GoatifyApp/Goatify/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Goatify Server",
                url = "wss://chotathor-goatify.hf.space/ws",
                location = "Global",
                operator = "ECHO"
            )
        )
