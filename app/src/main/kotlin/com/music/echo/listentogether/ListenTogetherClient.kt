...
package com.goatify.music.listentogether
...
import com.goatify.music.constants.ListenTogetherAutoApprovalKey
import com.goatify.music.constants.ListenTogetherIsHostKey
import com.goatify.music.constants.ListenTogetherRoomCodeKey
import com.goatify.music.constants.ListenTogetherServerUrlKey
import com.goatify.music.constants.ListenTogetherSessionTimestampKey
import com.goatify.music.constants.ListenTogetherSessionTokenKey
import com.goatify.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.goatify.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.goatify.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.goatify.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.goatify.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.goatify.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.goatify.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
