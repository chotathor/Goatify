package iad1tya.echo.music.goatify
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/GoatifyApp/workflows/nightly.yml/main/goatify-gms-nightly.zip"
        } else {
            "https://github.com/GoatifyApp/Goatify/releases/download/$versionName/goatify.apk"
        }
