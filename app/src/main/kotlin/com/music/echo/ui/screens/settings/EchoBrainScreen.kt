...
import com.goatify.music.data.EchoBrainRepository
import com.goatify.music.engine.EchoBrainEngine
import com.goatify.music.engine.brain.*
...
fun EchoBrainScreen(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.echo_brain_enable)),
                                        ...
                                        onCheckedChange = { isChecked ->
                                            ...
                                            coroutineScope.launch {
                                                context.dataStore.edit { prefs ->
                                                    prefs[com.goatify.music.constants.EchoBrainEnabledKey] = isChecked
                                                }
                                            }
                                        }
                                    )
                                ...
                                onClick = { 
                                    ...
                                    scope.launch {
                                        context.dataStore.edit { prefs ->
                                            prefs[com.goatify.music.constants.EchoBrainEnabledKey] = !isEnabled
                                        }
                                    }
                                }
                            )
