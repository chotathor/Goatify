...
import com.goatify.music.constants.EnableGoogleCastKey
...
import com.goatify.music.constants.SeekExtraSeconds
import com.goatify.music.constants.ShufflePlaylistFirstKey
import com.goatify.music.constants.SimilarContent
import com.goatify.music.constants.ShowAudioFallbackToastKey
...
import com.goatify.music.constants.EnableExportAsMp3Key

import com.goatify.music.constants.PreloadNextSongEnabledKey
import com.goatify.music.constants.PreloadNextSongLimitKey
import com.goatify.music.constants.PreloadLyricsEnabledKey
...
highlightKey: String? = null) {
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.goatify.music.constants.DownloadQualityKey,
        defaultValue = com.goatify.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(com.goatify.music.constants.DownloadQuality.YOUTUBE),
            valueText = {
                when (it) {
                    com.goatify.music.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    com.goatify.music.constants.DownloadQuality.SAAVN -> "Saavn (320kbps)"
                    com.goatify.music.constants.DownloadQuality.LOSSLESS -> "Qobuz (Lossless)"
                }
            }
        )
    }
    ...
    Column(
        ...
        if (showSaavnAudioWarning) {
            DefaultDialog(
                ...
                buttons = {
                    TextButton(onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://goatify.fun/donate"))
                ...
                Text("Saavn (320kbps) streams run through Goatify's servers and cost real money to keep running. If you find it useful, please consider donating to help keep this alive.\n\nNote: If Saavn playback fails, the app automatically falls back to YouTube Music's Opus stream.")
            }
        }
        ...
        if (showLosslessAudioWarning) {
            DefaultDialog(
                ...
                Text("Lossless (Qobuz) streams run through Goatify's servers and cost real money to keep running. If you find it useful, please consider donating — it directly helps cover server costs.\n\n" + stringResource(R.string.lossless_audio_warning))
            }
        }
