...
data class SongItem(
    ...
    override val shareLink: String
        get() = "https://share.goatify.fun/watch?v=$id"
}
...
data class AlbumItem(
    ...
    override val shareLink: String
        get() = "https://share.goatify.fun/playlist?list=$playlistId"
}
...
data class PlaylistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = "https://share.goatify.fun/playlist?list=$id"
}
...
data class ArtistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = "https://share.goatify.fun/channel/$id"
}
