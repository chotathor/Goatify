package com.goatify.music.goatifycanvas
...
@Serializable
data class goatifyCanvasManifest(
    val items: List<goatifyCanvasItem> = emptyList()
)

@Serializable
data class goatifyCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object goatifyCanvasProvider {
    private const val BASE_URL = "https://canvas.goatify.fun/canvas.json"
    ...
    private data class CacheEntry(
        val value: goatifyCanvasManifest?,
    ...
    private suspend fun fetchManifest(): goatifyCanvasManifest? {
        ...
        return try {
            val manifest: goatifyCanvasManifest = client.get(BASE_URL).body()
